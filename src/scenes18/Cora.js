CHARACTER_DATA.cora.dialog.sex = [
	{
		id : "quickiebj",
		...
		log : [
			...
			"She your shaft in her right hand and strokes it a few times, before leaning forward and putting her lips to it. as if kissing it",
			//TODO voice line
			{speaker:"Cora", text:"Go ahead and cum in my mouth whenever you're ready. I don't want to make a mess."},
			"Without any further hesitation, she opens her lips, sliding you into her mouth as her tongue gets your shaft wet.",
			{text:"She bobs a little as she getes to the shaft, going a little deeper with each pass. Her mouth is wet and warm, and the feeling of her tongue swishing past sends shivers up your spine."},
			"You let her take care of you. She goes deeper, sliding her hand and her lips along the entire length of your shaft.",
			"She keeps blowing you nice and fast, urging you to towards orgasm.",
			"Just a minute of Cora's enthusiastic blowjob and you're getting close to climaxing.",
			"When you start to tense up, she seals her lips tighty around your tip.",
			{text:"She jerks you off until you start to cum, firing your load right into her mouth.", countdown:"Cum"},
			"She continues stroking as you keep unloading in her mouth. Her lips stay sealed so she doesn't leak a singe drop.",
			"When you've finished, she pulls her lips off of you with a pop, and swallows all of your jizz in one big gulp.",
	...
	},*/
	{
		id : "sleepspoon",
		name : "Quickie blowjob",
		reqs : [{type:"outfit", outfit:"sleep"}, {type:"genconsent", min:.8}, {type:"pbody", part:"penis"}],
		//Lab Rats: hub_scenes.rpy:528
		log : [
